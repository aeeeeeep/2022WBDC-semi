...
def parse_args():
    ...
    parser.add_argument('--val_ratio', default=0.02, type=float, help='split 10 percentages of training data as validation')
    parser.add_argument('--batch_size', default=26, type=int, help="use for training duration per worker")
    ...
    parser.add_argument('--ckpt_file', type=str, default='model.trt.engine')
