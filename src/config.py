...
def parse_args():
    ...
    parser.add_argument('--k_folds', type=int, default=10, help='K fold Cross-Validation')
    parser.add_argument('--num_weights', type=int, default=20, help='Number of weights')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='weights/weight')
    parser.add_argument('--savedpretrain_model_path', type=str, default='data/pretrain')
